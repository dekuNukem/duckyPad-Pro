...
#define USER_VAR_END_ADDRESS_INCLUSIVE 0xF3FF

#define SCRATCH_MEM_START_ADDRESS 0xF400
#define SCRATCH_MEM_END_ADDRESS_INCLUSIVE 0xF7FF
...
void run_dsb(exe_context* ctx, uint8_t this_key_id, char* dsb_path, uint8_t* dsb_cache);
