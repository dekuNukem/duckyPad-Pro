...
#define CALL_STACK_BYTE_WIDTH 2
...
#define BIN_BUF_SIZE (EXE_BIN_END_ADDRESS_INCLUSIVE - EXE_BIN_START_ADDRESS + 1)
#define VAR_BUF_SIZE ((USER_VAR_END_ADDRESS_INCLUSIVE - USER_VAR_START_ADDRESS + 1)/USER_VAR_BYTE_WIDTH)
