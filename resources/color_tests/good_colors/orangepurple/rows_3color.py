...
start_color = (237, 118, 50)
middle_color = (240, 187, 51)
end_color = (64, 107, 162)

start_color = struct.unpack('BBB', bytes.fromhex("da6509"))
middle_color = struct.unpack('BBB', bytes.fromhex("e8bcf0")) #d5b6d5
end_color = struct.unpack('BBB', bytes.fromhex("da6509"))
