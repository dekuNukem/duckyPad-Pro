...
start_color = struct.unpack('BBB', bytes.fromhex("c3d1e6"))
middle_color = struct.unpack('BBB', bytes.fromhex("c16630"))
end_color = struct.unpack('BBB', bytes.fromhex("783215"))

# start_color = struct.unpack('BBB', bytes.fromhex("2a79d8"))
# middle_color = struct.unpack('BBB', bytes.fromhex("b0c9a4"))
# end_color = struct.unpack('BBB', bytes.fromhex("783215"))
